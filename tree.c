...
char *version = "$Version: $ tree v2.3.0 %s 1996 - 2025 by Steve Baker, Thomas Moore, Francesc Rocher, Florian Sesser, Kyosuke Tokoro, Pallav Bakshi $";
char *hversion= "\t\t tree v2.2.1 %s 1996 - 2024 by Steve Baker and Thomas Moore <br>\n"
		...
		"\t\t Word count feature and support for markdown output format %s 2025 by Pallav Bakshi\n";
